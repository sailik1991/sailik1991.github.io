...
EACL, 2023
<br>
[<button type="button" class="btn btn-outline-primary btn-sm">paper</button>](https://arxiv.org/abs/2210.04782)
...
- **Imperfect ImaGANation: Implications of GANs Exacerbating Biases in Facial Data Augmentation and Snapchap Selfie Lenses**
<br>
...
<br>
[<button type="button" class="btn btn-outline-primary btn-sm">paper</button>](./files/no_trust_rss_ws_2021.pdf) [<button type="button" class="btn btn-outline-primary btn-sm">arxiv</button>](https://arxiv.org/abs/1903.00111)

- **Imperfect ImaGANation: Implications of GANs Exacerbating Biases in Facial Data Augmentation**
<br>
_Niharika Jain\*, Alberto Olmo\*, Sailik Sengupta, Lydia Manikonda, Subbarao Kambhampati_
<br>
...
Ph.D. Thesis
<br>
[<button type="button" class="btn btn-outline-primary btn-sm">thesis</button>](https://repository.asu.edu/attachments/236231/content/Sengupta_asu_0010E_20368.pdf) [<button type="button" class="btn btn-outline-primary btn-sm">video</button>](https://www.youtube.com/watch?v=_b6Foq1M2rY&feature=youtu.be)
...
- **Moving Target Defense for Robust Fingerprinting of Electric Grid Transformers in Adversarial Environments**
<br>
